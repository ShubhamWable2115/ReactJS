...
//Props are just a normal arguments of a function and we can pass any type of data in props like string, number, array , object, function etc.
//Using the props we make the UI Dynamic by extracting and passing the data in the cards as well but still it's not ideal for large datasets.
// in the above example we render the data by its index value it                   


///nothing change just to add the commit